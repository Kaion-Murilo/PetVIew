...
namespace PetView
{
    public partial class Registros : UserControl
    {
        ...
        private void dgvParametros(String tabela, String coluna, String valor)
        {
            ...
            {
                case "Animal":
                    dgvRegistros.DataSource = AnimalDAL.Select(coluna, valor);
                    tb = "Animal";
                    break;

                case "Dono":
                    dgvRegistros.DataSource = DonoDAL.Select(coluna, valor);
                    tb = "Dono";
                    break;

                case "Consulta":
                    dgvRegistros.DataSource = ExameDAL.Select(coluna, valor);
                    tb = "Consulta";
                    break;
                ...
                case "Funcionário":
                    dgvRegistros.DataSource = FuncionarioDAL.Select(coluna, valor);
                    tb = "Funcionario";
                    break;

                case "Médico":
                    dgvRegistros.DataSource = MedicoData.Select(coluna, valor);
                    tb = "MEdico";
                    break;

                case "Tratamento":
                    tb = "Tratamento";
                    dgvRegistros.DataSource = TratamentoDAL.Select(coluna, valor);
                    break;
            }
        }
