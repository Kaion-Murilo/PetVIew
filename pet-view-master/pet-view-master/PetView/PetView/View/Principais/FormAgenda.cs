...
namespace PetView
{
    public partial class FormAgenda : UserControl
    {
        ...
        private void dgvParametros(String coluna, String valor)
        {
            ...
            {
                case "Consulta":
                    dgvAgenda.DataSource = ConsultaDAL.Select(coluna, valor);
                    break;

                case "Exame":
                    dgvAgenda.DataSource = ExameDAL.Select(coluna, valor);
                    break;

                case "Tratamento":
                    dgvAgenda.DataSource = TratamentoDAL.Select(coluna, valor);
                    break;
